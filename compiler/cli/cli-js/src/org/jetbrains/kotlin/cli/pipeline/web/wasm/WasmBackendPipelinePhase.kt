...
object WasmBackendPipelinePhase : WebBackendPipelinePhase<WasmBackendPipelineArtifact>("WasmBackendPipelinePhase") {
    ...
    internal fun compileNonIncrementally(
        ...
        val singleModuleName = configuration.get(WasmConfigurationKeys.SINGLE_MODULE)
        return if (singleModuleName == null) {
            ...
            } ?: error("Module $singleModuleName not found from available: ${module.klibs.all.joinToString(separator = ", ") { it.moduleName }}")
