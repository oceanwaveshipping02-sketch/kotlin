...
class FilePathNormalizationTest : KotlinIntegrationTestBase() {
    ...
    fun testSymlinksInContentRoots() {
        ...
        configuration.configureSourceRoots(listOf(object : Module {
            ...
            override fun getFriendPaths(): List<String> = emptyList()

            override fun getSourceFiles(): List<String> = emptyList()

            override fun getCommonSourceFiles(): List<String> = emptyList()

            override fun getClasspathRoots(): List<String> = listOf(linkToLibDir.path)

            override fun getJavaSourceRoots(): List<JavaRootPath> = emptyList()

            override val modularJdkRoot: String?
                get() = null
        }))
