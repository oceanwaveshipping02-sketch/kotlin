...
object FirErrors : KtDiagnosticsContainer() {
    ...
    val CONTEXT_SENSITIVE_RESOLUTION_AMBIGUITY: KtDiagnosticFactory1<Collection<FirBasedSymbol<*>>> = KtDiagnosticFactory1("CONTEXT_SENSITIVE_RESOLUTION_AMBIGUITY", ERROR, SourceElementPositioningStrategies.DEFAULT, KtElement::class, getRendererFactory())
