 ...
 */
internal inline val <T, reified S> T.compiledStub: S? where T : StubBasedPsiElementBase<in S>, T : KtElement
    get() {
        val loadedStub = loadStubByElement(this) ?: return null
        return loadedStub as S
    }

private fun <S, T> loadStubByElement(ktElement: T): Stub? where T : StubBasedPsiElementBase<in S>, T : KtElement {
