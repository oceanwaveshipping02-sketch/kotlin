...
import org.jetbrains.kotlin.AbstractAnalysisApiProjectPsiBasedTestWithMasterFile
 ...
 * and the master file [SourceDirectory.ForCheckAgainstMasterFile.outputFilePath]
 *
 ...
 */
class AnalysisApiContextParametersBridgesTest : AbstractAnalysisApiProjectPsiBasedTestWithMasterFile() {
    @Test
    ...
    override fun PsiFile.processFile(): List<String> = buildList {
        ...
        val membersBySessionComponents = this@processFile.getSessionComponentsAndMembers()
        ...
        for ((sessionComponent, members) in membersBySessionComponents) {
            members.filter { member ->
                bridgesByContextParameter[sessionComponent]?.any { bridge ->
    ...
    override fun SourceDirectory.ForCheckAgainstMasterFile.getErrorMessage(): String =
        """
    ...
    private fun KtFile.getSessionComponentsAndMembers(): Map<String, List<KtCallableDeclaration>> =
