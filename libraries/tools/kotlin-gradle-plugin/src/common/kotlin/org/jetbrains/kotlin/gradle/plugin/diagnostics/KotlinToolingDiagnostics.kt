...
internal object KotlinToolingDiagnostics {
    ...
    object DeprecatedKotlinVersionKotlinDsl : ToolingDiagnosticFactory(WARNING, DiagnosticGroup.Kgp.Misconfiguration) {
        internal class VersionMetadata(val version: KotlinVersion, val type: String, val accessor: String)

        operator fun invoke(versionMetadata: List<VersionMetadata>, nonDeprecatedVersion: KotlinVersion) = build {
            title("Unsupported Kotlin plugin version")
                .description {
                    ...
                    val accessorsSnippet = versionMetadata.joinToString("\n") { meta ->
                        "|        ${meta.accessor}.set(org.jetbrains.kotlin.gradle.dsl.KotlinVersion.$nonDeprecatedVersion)"
                    }
                    """
