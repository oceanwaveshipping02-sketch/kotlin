...
class NpmVersions : Serializable {
    val swcCli = NpmPackageVersion("@swc/cli", "0.7.8")
    val swcCore = NpmPackageVersion("@swc/core", "1.13.3")
    val swcHelpers = NpmPackageVersion("@swc/helpers", "0.5.17")
    val coreJs = NpmPackageVersion("core-js", "3.45.0")
    val webpack = NpmPackageVersion("webpack", "5.101.2")
    ...
    val sass = NpmPackageVersion("sass", "1.90.0")
