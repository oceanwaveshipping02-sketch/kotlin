...
internal fun KmType.toKType(
    ...
    val kClassifier = classifier.toClassifier(classLoader, typeParameterTable)
...
private fun KmClassifier.toClassifier(classLoader: ClassLoader, typeParameterTable: TypeParameterTable): KClassifier = when (this) {
